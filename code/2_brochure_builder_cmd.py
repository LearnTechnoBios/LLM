...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(description='Generate company brochure from website content')
    parser.add_argument('company_name', type=str, help='Name of the company')
    parser.add_argument('url', type=str, help='Base URL of company website')

    args = parser.parse_args()
    create_brochure(args.company_name, args.url)
